    ...
    <article>
      ...
      <div className="prose-custom space-y-8 text-sm text-[#F5F0E8]/70 leading-relaxed">
        ...
        <div className="border border-[#FF6B00]/40 bg-[#FF6B00]/5 p-6 relative">
          ...
          <h3 className="font-heading text-2xl tracking-widest text-[#F5F0E8] mb-3">MONITOR YOUR SAN ANTONIO PERMITS — FREE TO START</h3>
          <p className="text-xs text-[#F5F0E8]/60 leading-relaxed mb-4">
            ...
            Stop logging into SAconnect every morning. Track one permit free, forever.
          </p>
