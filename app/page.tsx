    ...
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-[#FF6B00]/20">
            ...
            />
            <div className="border-t md:border-t-0 md:border-l md:border-r border-[#FF6B00]/20">
              <PainPoint
                stat="3–5×"
      ...
      <section id="pricing" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="lg:col-span-2 border border-[#FF6B00] p-10 relative">
              ...
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  "Checks every 2–4 hours, 24/7",
                  "Instant email alerts on any status change",
                  "Full status history & audit trail",
                  "All supported cities (growing weekly)",
                  "Priority email support",
                  "14-day free trial included",
                ].map((feature) => (
                  <li key={feature} className="flex items-start gap-3 text-sm text-[#F5F0E8]/80">
              ...
              <PrimaryCTA />
              <p className="mt-4 text-xs text-[#F5F0E8]/30">
            ...
            <div className="border border-[#FF6B00]/20 border-t-0 lg:border-t lg:border-l-0 p-8 bg-[#FF6B00]/5">
              ...
              <div className="space-y-6">
                ...
                <p className="text-xs text-[#F5F0E8]/60 leading-relaxed">
                  If this saves you even half a day, it pays for itself.
                </p>
              </div>
            </div>
          </div>
          ...
          <p className="mt-6 text-xs text-[#F5F0E8]/30 text-center">
            This is one of those tools you don&apos;t think twice about.
          </p>
        </div>
      </section>
      ...
      <footer className="border-t border-[#FF6B00]/20 px-6 py-10">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Cities notice */}
          <div className="border-t border-[#FF6B00]/10 pt-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
            <div className="text-[10px] text-[#FF6B00]/40 tracking-widest uppercase font-mono">
              Currently monitoring: Austin, TX · Dallas, TX · Houston, TX
              <span className="text-[#F5F0E8]/20 ml-3">· More cities added weekly based on demand</span>
            </div>
